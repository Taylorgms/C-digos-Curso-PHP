<?php
    ...
    $resultado = $nova_selecao->selecionar("estado");
  ...
  <body>
    ...
    <div class="container">
        ...
        <form action="../Services/validar_cadastro_action.php" method="post">
            <input type="hidden" name="PEC" value="estado">
            <div class="row">
                <div class="col-md-5">
                    <div style="margin-bottom: 3%;margin-top: 13%;" class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Adicione o estado aqui..." name="PEC_valor">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> 
                        ...
                        <a href="../View/editarPEC.php?id=<?= $row['id']; ?>&PEC=estado" class="btn btn-primary">Editar</a>

                        <a href="../Services/deletar_action.php?id=<?= $row['id']; ?>&PEC=estado" onclick="return confirm('Você tem certeza que quer deletar?')" class="btn btn-danger"> Deletar </a>
