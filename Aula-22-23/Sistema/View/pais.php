<?php
    ...
    $resultado = $nova_selecao->selecionar("pais");
  ...
  <body>
    ...
    <div class="container">
        ...
        <form action="../Services/validar_cadastro_action.php" method="post">
            <input type="hidden" name="PEC" value="pais">
            <div class="row">
                <div class="col-md-5">
                    <div style="margin-bottom: 3%;margin-top: 13%;" class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Adicione o pais aqui..." name="PEC_valor">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> 
                        ...
                        <a href="../View/editarPEC.php?id=<?= $row['id']; ?>&PEC=pais" class="btn btn-primary">Editar</a>

                        <a href="../Services/deletar_action.php?id=<?= $row['id']; ?>&PEC=pais" onclick="return confirm('Você tem certeza que quer deletar?')" class="btn btn-danger"> Deletar </a>
